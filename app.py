...
button_solve = tk.Button(win, text = 'Çöz', command = solve_sudoku)
button_clear_all = tk.Button(win, text = 'Hepsini Sil', command = clear_list_all)
button_clear = tk.Button(win, text = 'Temizle', command = clear_list_sp)
...
edit_bar.add_command(label = 'Hepsini Sil', command = clear_list_all)
edit_bar.add_command(label = 'Çöz', command = solve_sudoku)
menu_file.add_cascade(label = 'Seçenekler', menu = edit_bar)
